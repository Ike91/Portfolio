    ...
    <div class="education">
      ...
      <div class="row" style="margin-top: 1em">
        <div class="col-sm-12 col-md-4">
          ...
          <div class="bar front expert" data-skill="GIT & GITHUB"></div>
        </div>
        ...
        <div class="col-sm-12 col-md-4">
          ...
          <div class="bar back basic" data-skill="SPRING BOOT"></div>
  ...
  data() {
    return {
      ...
      skills : [
        ...
        {name: "C++", link: "./skills/"},
        {name: "JAVA", link: "./skills/"},
        {name: "PHP", link: "./skills/"},
        {name: "LARAVEL", link: "./skills/"},
        {name: "VUE.JS", link: "./skills/"},
        {name: "SPRING BOOT", link: "./skills/"},
        {name: "FIREBASE", link: "./skills/"},
        {name: "GIT & GITHUB", link: "./skills/"},
        {name: "REST + SOAP API", link: "./skills/"},
